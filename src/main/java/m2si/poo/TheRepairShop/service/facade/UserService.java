...
public interface UserService {
    CreatedUserPasswordDto createReparateur(String username, String email, Long shopId);
    ...
    CreatedUserPasswordDto createOwner(String username, String email, String plainPassword);
